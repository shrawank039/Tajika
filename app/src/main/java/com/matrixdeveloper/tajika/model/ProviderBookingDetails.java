...
public class ProviderBookingDetails implements Serializable
{
    ...
    @SerializedName("serviceprovideraddress")
    @Expose
    private String serviceprovideraddress;
    @SerializedName("customerrating")
    @Expose
    private String customerrating;
    private final static long serialVersionUID = 8623643136008230187L;
